...
def main(page: ft.Page):
    ...
    def finalizar_pago_total(metodo):
        ...
        print(f"\n" + "!"*45 + f"\n REPORTE CIERRE MESA {m_id} | TOTAL: ${total}\n MÉTODO: {metodo.upper()}\n FECHA: {datetime.now()}\n" + "!"*45)
